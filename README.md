...
| 4 | [user-accounts](chapters/04-user-accounts/README.md) | A `users` table, password hashing with `argon2`, register/login |
| 5 | [sessions](chapters/05-sessions/README.md) | Cookie sessions, protecting a page, routing between pages |

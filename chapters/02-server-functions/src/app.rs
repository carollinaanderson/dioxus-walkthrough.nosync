...
//! Still one component, no routing — but now the button click round-trips to
//! a real server process instead of just updating local state.
...
pub fn App() -> Element {
    ...
    rsx! {
        ...
        main { class: "wrap",
            h1 { "MyApp" }
            p { class: "sub", "Chapter 2: server functions." }
            section { class: "card",
